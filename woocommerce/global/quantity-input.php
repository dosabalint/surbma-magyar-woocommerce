...
if ( $max_value && $min_value === $max_value ) {
	...
	<div class="quantity">
		<!-- EXTRA CODE START -->
		<?php if( $plusminusValue == 1 ) echo '<button type="button" class="qty-button minus">-</button>'; ?>
		<!-- EXTRA CODE END -->
		...
		<!-- EXTRA CODE START -->
		<?php if( $plusminusValue == 1 ) echo '<button type="button" class="qty-button plus">+</button>'; ?>
		<!-- EXTRA CODE END -->
	</div>
	<?php
}
